...
function draw(art: string, ar: boolean, compact: boolean) {
  ...
  if (art === "neural") {
    return (
      <>
        <line x1="70" y1="56" x2="150" y2="40" stroke="#94a3b8" strokeWidth="3" />
        <line x1="70" y1="56" x2="150" y2="100" stroke="#94a3b8" strokeWidth="3" />
        <line x1="70" y1="144" x2="150" y2="100" stroke="#94a3b8" strokeWidth="3" />
        <line x1="70" y1="144" x2="150" y2="160" stroke="#94a3b8" strokeWidth="3" />
        <line x1="150" y1="40" x2="240" y2="70" stroke="#94a3b8" strokeWidth="3" />
        <line x1="150" y1="100" x2="240" y2="100" stroke="#94a3b8" strokeWidth="3" />
        <line x1="150" y1="160" x2="240" y2="130" stroke="#94a3b8" strokeWidth="3" />
        <circle cx="70" cy="56" r="13" fill="#0c2d6b" />
        <circle cx="70" cy="144" r="13" fill="#0c2d6b" />
        <circle cx="150" cy="40" r="13" fill="#1d4ed8" />
        <circle cx="150" cy="100" r="13" fill="#1d4ed8" />
        <circle cx="150" cy="160" r="13" fill="#1d4ed8" />
        <circle cx="240" cy="70" r="13" fill="#c4a35a" />
        <circle cx="240" cy="130" r="13" fill="#c4a35a" />
      </>
    );
  }
  if (art === "ml") {
    return (
      <>
        <rect x="40" y="48" width="72" height="104" rx="12" fill="#0c2d6b" />
        <rect x="124" y="36" width="72" height="128" rx="12" fill="#1d4ed8" />
        <rect x="208" y="64" width="72" height="72" rx="12" fill="#c4a35a" />
        <path d="M112 100 H124 M196 100 H208" stroke="#64748b" strokeWidth="6" />
        {compact ? null : (
          <>
            <Label x={76} y={106} text={ar ? "بيانات" : "Data"} />
            <Label x={160} y={106} text={ar ? "نموذج" : "Model"} />
            <Label x={244} y={106} text={ar ? "حكم" : "Judge"} fill="#111827" />
          </>
        )}
      </>
    );
  ...
  if (art === "llm") {
    return (
      <>
        <rect x="36" y="40" width="150" height="70" rx="16" fill="#0c2d6b" />
        <rect x="46" y="52" width="96" height="10" rx="5" fill="#93c5fd" />
        <rect x="46" y="70" width="70" height="10" rx="5" fill="#bfdbfe" />
        <rect x="134" y="128" width="150" height="48" rx="16" fill="#c4a35a" />
        <path d="M186 40 l10 22 24 2-18 16 6 24-22-14-22 14 6-24-18-16 24-2z" fill="#f59e0b" />
      </>
    );
  }
  if (art === "lock") {
    return (
      <>
        <path d="M128 88 v-18 a32 32 0 0 1 64 0 v18" fill="none" stroke="#111827" strokeWidth="12" />
        <rect x="108" y="88" width="104" height="78" rx="14" fill="#7f1d1d" />
        <circle cx="160" cy="122" r="10" fill="#fde68a" />
        <rect x="156" y="122" width="8" height="22" fill="#fde68a" />
      </>
    );
  }
  if (art === "firewall") {
    return (
      <>
        <rect x="28" y="36" width="78" height="48" rx="10" fill="#7f1d1d" />
        <rect x="214" y="36" width="78" height="48" rx="10" fill="#16a34a" />
        <rect x="70" y="108" width="180" height="56" rx="10" fill="#0c2d6b" />
        <path d="M106 84 V108 M214 84 V108" stroke="#334155" strokeWidth="6" />
        {compact ? null : (
          <>
            <Label x={67} y={66} text={ar ? "خطر" : "Risk"} />
            <Label x={253} y={66} text={ar ? "آمن" : "Safe"} />
  ...
  if (art === "http") {
    return (
      <>
        ...
        <path d="M132 90 H188" stroke="#c4a35a" strokeWidth="8" />
  ...
  if (art === "cloud") {
    return (
      <>
        <ellipse cx="160" cy="108" rx="78" ry="40" fill="#0c2d6b" />
        <ellipse cx="118" cy="112" rx="36" ry="28" fill="#0c2d6b" />
        <ellipse cx="204" cy="110" rx="34" ry="26" fill="#0c2d6b" />
        <rect x="148" y="142" width="24" height="16" rx="3" fill="#c4a35a" />
      </>
    );
  }
  if (art === "ux") {
  ...
  if (art === "regress") {
    return (
      <>
        ...
        <line x1="72" y1="136" x2="248" y2="52" stroke="#1d4ed8" strokeWidth="5" />
        ...
        <circle cx="236" cy="62" r="7" fill="#c4a35a" />
      </>
    );
  }
  if (art === "data") {
  ...
  if (art === "api") {
    return (
      <>
        ...
        <path d="M104 100 H120 M200 100 H216" stroke="#64748b" strokeWidth="6" />
        {compact ? null : (
          <>
  ...
  if (art === "ethics") {
    return (
      <>
        <rect x="150" y="28" width="20" height="132" fill="#0c2d6b" />
        <rect x="64" y="68" width="192" height="12" fill="#111827" />
        <rect x="56" y="80" width="64" height="48" rx="6" fill="#c4a35a" />
        <rect x="200" y="80" width="64" height="48" rx="6" fill="#7f1d1d" />
      </>
    );
  }
