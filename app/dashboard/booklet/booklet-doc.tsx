...
export function BookletAssessPane({ locale = "ar", lessonId }: { locale?: "ar" | "en"; lessonId: string }) {
  ...
  return (
    <div
      className="booklet-paper print-sheet rounded-xl bg-white p-5 ring-1 ring-slate-300 sm:p-8"
      lang={locale}
      dir={ar ? "rtl" : "ltr"}
    >
      <BookletCover
        ...
        teacher={ar ? BRAND.teacherAr : BRAND.teacherEn}
        brand={ar ? BRAND.nameAr : BRAND.nameEn}
        kicker={ar ? "الأداءات والتقييمات" : "Performances and assessments"}
        title={`${lessonId} — ${ar ? title.titleAr : title.titleEn}`}
