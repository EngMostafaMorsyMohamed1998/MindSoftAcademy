...
export const EXTRA_HOMEWORK: ExtraHomework[] = [
  ...
  tf("1-1-x4", "1-1", "1", "الواقع الافتراضي يضيف طبقة على الشارع الحقيقي ولا يستبدل العالم.", "Virtual reality adds a layer on the real street and does not replace the world.", false),
  ...
  tf(
    ...
    "1-3",
    "1",
    "الذكاء العام الذي يفهم كل شيء مثل الإنسان هو شكل معظم أنظمة اليوم.",
    "General AI that understands everything like a person is the form of most systems today.",
    false,
  ),
  ...
  mcq("2-3-x1", "2-3", "2", "أي تصرف غلط بعد اكتشاف برمجية خبيثة؟", "Which action is wrong after finding malware?", ["فصل الجهاز عن الشبكة", "مسح القرص فورًا قبل أي تسجيل", "إخبار المسؤول", "حفظ وقت الاكتشاف"], ["Disconnect the machine from the network", "Wipe the disk immediately before any record", "Tell the person in charge", "Note the time of discovery"], 1),
