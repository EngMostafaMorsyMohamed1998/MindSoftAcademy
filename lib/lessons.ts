...
export const LESSON_NOTES: LessonNote[] = [
  {
    ...
    termsAr: [
      ...
      { term: "شبكات التواصل الاجتماعي", meaning: "خدمات تربط المستخدمين لنشر المعلومات ومشاركتها بسرعة." },
      { term: "التجارة الإلكترونية", meaning: "بيع وشراء السلع والخدمات عبر الإنترنت." },
      { term: "العمل عن بُعد", meaning: "أداء العمل من البيت أو مكان بعيد باستخدام الإنترنت." },
      { term: "التعلّم عبر الإنترنت", meaning: "حصص ومواد دراسية تصل عبر الإنترنت." },
      { term: "الدفع بلا نقد", meaning: "دفع إلكتروني ببطاقات أو رمز استجابة سريعة من غير كاش." },
    ...
    termsEn: [
      ...
      { term: "SNS", meaning: "Services that let users connect and share information quickly." },
      { term: "E-commerce", meaning: "Buying and selling goods and services through the Internet." },
      { term: "Remote work", meaning: "Doing the job from home or another place over the Internet." },
      { term: "Online learning", meaning: "Classes and study materials delivered over the Internet." },
      { term: "Cashless payment", meaning: "Paying with electronic money or QR codes, without cash." },
