...
export const LESSON_NOTES: LessonNote[] = [
  {
    ...
    bodyAr: [
      ...
      "كل مرحلة غيّرت المجتمع: البريد الإلكتروني، العمل عن بُعد، التعلّم عبر الإنترنت، التجارة الإلكترونية، والدفع بلا نقد.",
      "قانون مور اقترب من حد فيزيائي؛ لذلك تظهر مسارات جديدة مثل المعالجة المتوازية والحوسبة الكمومية.",
      "القيادة الذاتية تحتاج حوسبة طرفية لأن تأخير 0.1 ثانية قد يسبب حادثًا.",
    ],
    bodyEn: [
      "IT moved in stages: room-sized computers, personal computers, the Internet, smartphones, then cloud and AI as a service.",
      "Each stage changed society: email, remote work, online learning, e-commerce, and cashless payment.",
      "Moore's Law is hitting a physical limit, so new paths appear: parallel cores and quantum computing.",
      "Self-driving cars need edge computing because a 0.1s delay can cause an accident.",
    ],
  ...
  },
  {
    ...
    chapterId: "3",
    termsAr: [
      { term: "الواجهة الأمامية", meaning: "ما يراه المستخدم في المتصفح: HTML وCSS وجافاسكربت." },
    ...
    bodyAr: [
      ...
      "لا تضع سرًا (مفتاح أو كلمة مرور) داخل كود الواجهة؛ المتصفح مكشوف.",
    ],
    bodyEn: [
  ...
  },
  {
    ...
    chapterId: "3",
    termsAr: [
      { term: "HTTP", meaning: "بروتوكول طلب واستجابة بين المتصفح والخادم." },
      { term: "HTTPS", meaning: "HTTP فوق قناة مشفّرة (TLS)." },
      { term: "API", meaning: "واجهة يتفق عليها برنامجان لتبادل البيانات." },
      { term: "REST / JSON", meaning: "نمط شائع: موارد وعناوين، وغالبًا بيانات JSON." },
    ],
    termsEn: [
    ...
    bodyAr: [
      "الطرق الشائعة: GET للقراءة، POST للإنشاء، PUT/PATCH للتحديث، DELETE للحذف.",
      "رمز الحالة يخبر النتيجة: 200 نجاح، 404 غير موجود، 500 خطأ خادم.",
      "الكوكيز والجلسات تحفظ حالة تسجيل الدخول بعد الطلب.",
    ],
    bodyEn: [
  ...
  },
  {
    ...
    chapterId: "3",
    termsAr: [
      { term: "HTML", meaning: "هيكل الصفحة ومعناها." },
      { term: "CSS", meaning: "المظهر: الألوان، الشبكة، التجاوب." },
      { term: "JavaScript", meaning: "السلوك والتفاعل بعد التحميل." },
    ...
    bodyAr: [
      "ابدأ بالمعنى الصحيح للعناصر: عنوان، زر، قائمة؛ لا تجعل كل شيء <div>.",
  ...
  },
  {
    ...
    bodyAr: [
      ...
      "الـ API يعطيك شريحة حية؛ الملف المحمّل قد يكون قديمًا.",
